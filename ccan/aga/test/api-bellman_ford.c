...
static void test_trivial(void)
{
	...
	ok1(aga_bellman_ford_step(&tg.sg.g) == &tg.sg.nodes[1]);
	ok1(aga_bellman_ford_step(&tg.sg.g) == NULL);
...
static void test_parallel(void)
{
	...
	ok1(aga_bellman_ford_step(&pg.sg.g) == &pg.sg.nodes[1]);
	ok1(aga_bellman_ford_step(&pg.sg.g) == &pg.sg.nodes[2]);
	ok1(aga_bellman_ford_step(&pg.sg.g) == NULL);
...
static void test_shortcut2(void)
{
	...
	aga_bellman_ford_all_paths(&s2g.sg.g);
